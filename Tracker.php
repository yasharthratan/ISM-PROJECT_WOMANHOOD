        ...
        <div class="container-fluid">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="index.php">
                        <img src="assets/images/womanhood-logo.png" alt="login" style="height: 5rem;">
                    </a>
                </span>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                    ...
                    <li class="nav-item">
                        <a class="nav-link link text-black display-4" href="index.php#tabs1-p">AI Diagnosis</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link text-black display-4" href="signup.php">Dashboard</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link link text-black dropdown-toggle display-4" href="#" data-toggle="dropdown-submenu" aria-expanded="false">Appointments</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link link text-black display-4" href="Tracker.php">P-Tracker</a>
                    </li>
                </ul>
            </div>
        </div>
...
<section class="info3  mbr-parallax-background" id="info3-r" style="margin-top:30px; " style="background-color: black !important">
<div class="mbr-overlay" style="opacity: 0.6; background-color: rgb(255, 177, 138);">
            ...
            <div class="card col-12 col-lg-10">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <div id="track-head">
                            <img id="track-page-img" src="assets/images/calender.png">
    ...
    <div>
        ...
        <div id="track-input">
            ...
            <div class="mood-flow" style="">
                <div style="display:flex; align-items:center;">
                    <img src="assets/images/blood.png" id="flow">
                    <h3>Flow:</h3>
                </div>
            ...
            <div class="mood-flow" style="">
                <div style="display:flex; align-items:center;">
                    <img src="assets/images/mood(1).png" id="mood">
                    <h3>Mood:</h3>
                </div>
        ...
        <div id="predict" style="background-color: black;">
...
<section class="footer3 cid-s48P1Icc8J" once="footers" id="footer3-i"><div class="container">
        <div class="media-container-row align-center mbr-white">
            ...
            <div class="row row-copirayt">
                <p class="mbr-text mb-0 mbr-fonts-style mbr-white align-center display-7">Made by Team TECH-TAGARYEN&nbsp;</p>
            </div>
        </div>
    </div>
</section>
